...
export class Logger implements LoggerService {
  ...
  log(message: any, extra?: string | IExtra) {
    this._log(LogType.log, message, extra);
  }

  error(message: any, extra?: string | IExtra) {
    this._log(LogType.error, message, extra);
  }

  warn(message: any, extra?: string | IExtra) {
    this._log(LogType.warn, message, extra);
  }

  debug(message: any, extra?: string | IExtra) {
    this._log(LogType.debug, message, extra);
  }

  verbose(message: any, extra?: string | IExtra) {
